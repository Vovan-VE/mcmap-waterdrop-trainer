...
execute unless block 1 0 0 minecraft:bedrock unless block 10 202 12 minecraft:lever[powered=true] run playsound minecraft:entity.player.levelup master @p[tag=inGame] ~ ~ ~ 200
